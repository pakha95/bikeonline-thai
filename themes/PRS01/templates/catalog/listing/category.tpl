...
{block name='product_list_header'}
    ...
    {if isset($subcategories)}
        ...
        <div id="subcategories">
            ...
            <!-- <ul class="clearfix"> -->
                <h6>
                {foreach from=$subcategories item=subcategory name=smartyloop}
                    ...
                    <!-- <li> -->
                        ...
                        {if $counter>1}<span style="font-weight: lighter;">| </span>{/if}
                        <a class="subcategory-name" href="{$link->getCategoryLink($subcategory.id_category, $subcategory.link_rewrite)|escape:'html':'UTF-8'}">{$subcategory.name|truncate:25:'...'|escape:'html':'UTF-8'}<span style="font-weight: lighter;font-size:0.9em;">({$subcategory.nbproducts})</span></a>
